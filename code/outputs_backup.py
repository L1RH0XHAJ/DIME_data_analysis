...
#     7 hedging_money_dem_primary_normalized: Normalized version of hedging_money_dem_primary

#     8 hedging_money_rep_primary: Same as hedging_money_general but computed using contributions to two main candidates in Rep primary only

#     9 hedging_money_rep_primary_normalized: Normalized version of hedging_money_dem_primary
